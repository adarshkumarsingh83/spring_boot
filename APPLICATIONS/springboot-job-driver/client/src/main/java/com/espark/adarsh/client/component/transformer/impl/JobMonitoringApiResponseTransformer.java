...
@RequestTransformer(name = "espark-job-monitoring-response-transformer")
public class JobMonitoringApiResponseTransformer<T> implements ApiResponseTransformer<T> {
