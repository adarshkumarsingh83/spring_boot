...
public class EmployeeKey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3523745509766253431L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"EmployeeKey\",\"namespace\":\"com.espark.adarsh.entities\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"firstName\",\"type\":\"string\"}]}");
   ...
   */
  public EmployeeKey(java.lang.Integer id, java.lang.CharSequence firstName) {
    this.id = id;
   ...
   */
  public static com.espark.adarsh.entities.EmployeeKey.Builder newBuilder() {
    return new com.espark.adarsh.entities.EmployeeKey.Builder();
  }
   ...
   * @return A new EmployeeKey RecordBuilder
   */
  public static com.espark.adarsh.entities.EmployeeKey.Builder newBuilder(com.espark.adarsh.entities.EmployeeKey.Builder other) {
    return new com.espark.adarsh.entities.EmployeeKey.Builder(other);
  }
   ...
   * @return A new EmployeeKey RecordBuilder
   */
  public static com.espark.adarsh.entities.EmployeeKey.Builder newBuilder(com.espark.adarsh.entities.EmployeeKey other) {
    return new com.espark.adarsh.entities.EmployeeKey.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EmployeeKey>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.espark.adarsh.entities.EmployeeKey.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.espark.adarsh.entities.EmployeeKey other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.espark.adarsh.entities.EmployeeKey.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.espark.adarsh.entities.EmployeeKey.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.espark.adarsh.entities.EmployeeKey.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.espark.adarsh.entities.EmployeeKey.Builder clearFirstName() {
      firstName = null;
