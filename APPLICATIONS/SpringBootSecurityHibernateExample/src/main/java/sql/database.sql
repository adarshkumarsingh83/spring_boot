...
CREATE TABLE  `espark`.`user_role_mapping` (
...
INSERT INTO `espark`.`USERROLE`(`ID`,`NAME`)
VALUES(1,'ROLE_SUPERADMIN')
     ,(2,'ROLE_ADMIN')
     ,(3,'ROLE_USER');

INSERT INTO `espark`.`user_role_mapping`(`User_id`,`userRoles_id`)
